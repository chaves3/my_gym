...
<div class="menu">
    ...
    <div class="items-menu">
		...
		<a <?php selecionarMenu('conferir-informacoes'); ?>  href="<?php echo INCLUDE_PATH_PAINEL; ?>conferir-informacoes">Conferir Informações</a>
		<h2>Configurações Login</h2>
		...
		<a <?php selecionarMenu('editar-usuario'); ?>  href="<?php echo INCLUDE_PATH_PAINEL; ?>editar-usuario">Editar Sub Administradores</a>
       
        <?php if($_SESSION['cargo'] == 3){ ?>
		<a  <?php selecionarMenu('adicionar-usuario'); ?> <?php vereficaPermissaoMenu(2); ?> href="<?php echo INCLUDE_PATH_PAINEL; ?>adicionar-usuario">Adicionar Sub Administradores</a>
        <?php } ?>
