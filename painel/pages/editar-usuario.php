...
<div class="box-content">
    <h2><i class="bi bi-pen-fill"></i> Editar Seus Dados</h2>
...
$administradores = MySql::conectar()->prepare("SELECT * FROM tb_clientes WHERE cargo = ?");
$administradores->execute(array(2));
$administradores = $administradores->fetchAll();

?>

<?php 
  $adminGeral = MySql::conectar()->prepare("SELECT * FROM tb_clientes WHERE email = ?");
  $adminGeral->execute(array($_SESSION['email']));

  foreach ($adminGeral as $key => $value) {
     $emailAdmin = $value['email'];

  }

if($emailAdmin == 'matheussilvachaves19@gmail.com'){
?>

<div class="box-content  w100">
    <h2><i class="bi bi-collection"></i>Administradores Cadastrados - <?php ?></h2>
    <div class="table-responsive">
        ...
        <div class="row">
            ...
            <div class="col">
                <button class="editar-btn-cliente"><a href="<?php echo INCLUDE_PATH_PAINEL ?>editar-administrador?id=<?php echo $key['id']; ?>">EDITAR</a></button>
            </div><!--col-->
